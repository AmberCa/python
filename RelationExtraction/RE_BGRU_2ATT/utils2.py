...
def getModelPath2(entityType):
	modelPath = {'per_per' : 'RE_BGRU_2ATT/model/per_per/ATT_GRU_model', 
				'per_phone' : 'RE_BGRU_2ATT/model/per_phone/ATT_GRU_model'}
	return modelPath.get(entityType)

def copyList(sourceList, targetList):
	for info in sourceList:
