    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            def test_step(word_batch, pos1_batch, pos2_batch, y_batch):
               ...
               # print("before---------------total_num:%s"%total_num)
               # print("before---------------total_shape:%s"%total_shape)
               # print("before---------------total_word:%s"%total_word)
               # print("before---------------total_pos1:%s"%total_pos1)
               # print("before---------------total_pos2:%s"%total_pos2)
                total_shape.append(total_num)
               # print("---------------------tltal_shape.append:%s"%total_shape)
                total_shape = np.array(total_shape)
                total_word = np.array(total_word)
                total_pos1 = np.array(total_pos1)
                total_pos2 = np.array(total_pos2)
               # print("after---------------total_num:%s"%total_num)
               # print("after---------------total_shape:%s"%total_shape)
               # print("after---------------total_word:%s"%total_word)
                #print("after---------------total_pos1:%s"%total_pos1)
                #print("after---------------total_pos2:%s"%total_pos2)

                #print("--------------------------------------------------------------------")
                #print("------------y_batch:%s"%y_batch)
                #print("------------mtest.input_y:%s"%mtest.input_y)
                feed_dict[mtest.total_shape] = total_shape
                feed_dict[mtest.input_word] = total_word
                feed_dict[mtest.input_pos1] = total_pos1
                feed_dict[mtest.input_pos2] = total_pos2
                ...
                #print("----------mtest.loss:%s"%mtest.loss)
                #print("----------mtest.accuracy:%s"%mtest.accuracy)
                #print("----------mtest.prob:%s"%mtest.prob)
